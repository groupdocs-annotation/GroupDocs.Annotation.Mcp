...
public class RemoveRepliesToolTests
{
    ...
    public RemoveRepliesToolTests()
    {
        _output = new OutputHelper(_storage.Object, Microsoft.Extensions.Options.Options.Create(new McpConfig()));
    }

    [Fact]
    public async Task RemoveReplies_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            RemoveRepliesTool.RemoveReplies(
                _resolver.Object,
                _storage.Object,
    ...
    [Fact]
    public async Task RemoveReplies_WhenResolverThrows_DoesNotWriteToStorage()
    {
        _resolver
            .Setup(r => r.ResolveAsync(It.IsAny<FileInput>(), It.IsAny<CancellationToken>()))
            .ThrowsAsync(new FileNotFoundException("missing.pdf"));
    ...
    [Fact]
    public async Task RemoveReplies_SetsLicense_BeforeResolving()
    {
    ...
    [Fact]
    public async Task RemoveReplies_PassesFileInputToResolver_Unchanged()
    {
